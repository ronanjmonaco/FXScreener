  ...
  <body>
    <header class="site-header">
      <div class="container">
        ...
        <div class="header-right">
          <div class="status">
            <span id="last-updated" aria-live="polite">Actualizado —</span>
          </div>
    ...
    <main class="container">
      <section class="intro">
        ...
        <p class="section-subtitle">Dólar MEP y CCL en Tiempo Real</p>
      </section>
        ...
        <div class="card-header">
          ...
          <div class="badges">
            ...
            <div class="comision-pill">
              <label for="comision-selector">Comisión %</label>
        ...
        <div class="calculator-wrapper">
          <div class="calculator-form">
            <div class="form-row">
              ...
              <div class="form-group">
                <label for="comision-calc">Comisión</label>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', () => {
        ...
        function renderUpdatedAt() {
          ...
          if(updatedEl) updatedEl.textContent = `Actualizado — ${formatted}`;
        }
        renderUpdatedAt();
        ...
        function playBellSound() {
          ...
          try {
            ...
            // Set bell sound properties (more bell-like)
        ...
        // Comisión selector functionality
        ...
        if (comisionSelector) {
          ...
          comisionSelector.addEventListener('change', function() {
            ...
            console.log('Comisión changed to:', selectedComision + '%');
          });
        }
        ...
        function calculateFX() {
          ...
          if (tcMesa > 0) {
            ...
            if (accion === 'compra') {
              // Compra = TC Mesa * (1 + Comisión)
              tcCliente = tcMesa * (1 + comision / 100);
            } else {
              // Venta = TC Mesa / (1 + Comisión)
              tcCliente = tcMesa / (1 + comision / 100);
            }
            ...
            // Calculate Total based on Acción
            if (monto > 0) {
              let total;
